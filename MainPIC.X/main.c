...
/*global variable*/
float speedTarget;  //Target speed for PID. Set in Motor Driver and passed to PID in Timer 1.
char commSend[7];   //Used as a buffer for PIC to PIC comms
